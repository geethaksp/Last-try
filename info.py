...
MULTI_FSUB = [int(channel_id) for channel_id in environ.get('AUTH_CHANNEL', '-1002440222103').split() if re.match(r'^-?\d+$', channel_id)]  # Channel for force sub (make sure bot is admin)
